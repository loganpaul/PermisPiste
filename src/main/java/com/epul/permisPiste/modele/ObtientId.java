...
public class ObtientId implements java.io.Serializable {
	...
	public boolean equals(Object other) {
		...
		return (this.getNumapprenant() == castOther.getNumapprenant())
				&& ((this.getDatejour() == castOther.getDatejour()) || (this.getDatejour() != null && castOther.getDatejour() != null && this.getDatejour().equals(
						castOther.getDatejour()))) && (this.getNumaction() == castOther.getNumaction());
	}
	...
	public int hashCode() {
		...
		result = 37 * result + (getDatejour() == null ? 0 : this.getDatejour().hashCode());
